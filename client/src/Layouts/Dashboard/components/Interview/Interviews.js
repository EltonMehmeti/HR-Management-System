...
const Interviews = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-4 justify-center h-full font-sans font-medium m-10">
          ...
          {firstInterview?.map((interview) => {
            ...
            return (
              <div class="relative py-8 px-4 mt-1 sm:px-8 border-2 border-gray-200 dark:border-gray-700 max-w-sm mx-auto bg-white rounded-xl shadow-lg space-y-2 sm:py-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-6">
                ...
                <img
                  class=" mx-auto md:hidden lg:block sm:hidden  h-12 rounded-full sm:mx-0 sm:shrink-0"
                ...
                <div class="text-center space-y-2 sm:text-left">
                  ...
                  <span class="bg-green-100 text-green-800 text-xs font-medium flex flex-row justify-center items-center gap-1 me-2 px-0 py-0.5 rounded dark:bg-gray-700 dark:text-green-400 border border-green-400">
                    <svg
                      class="w-3 h-3 sm:w-4 sm:h-4 text-gray-800 dark:text-white"
                      aria-hidden="true"
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
          ...
          {jobOffer?.map((interview) => {
            return (
              <div class="relative py-8 px-4 mt-1 sm:px-8 border-2 border-gray-200 dark:border-gray-700 max-w-sm mx-auto bg-white rounded-xl shadow-lg space-y-2 sm:py-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-6">
                ...
                <img
                  class=" mx-auto md:hidden lg:block sm:hidden h-14 rounded-full sm:mx-0 sm:shrink-0"
                  src="https://tailwindcss.com/img/erin-lindford.jpg"
                  alt="Woman's Face"
                />
                <div class="text-center space-y-2 sm:text-left">
      ...
      <div className="flex flex-col h-[80vh] min-h-5/6 bg-white rounded-xl lg:w-1/4 overflow-y-scroll">
        <span className="bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br text-white py-4 text-center rounded-xl">
          Hired
        </span>
        <div className="bg-white p-4 m-2">
          {hired?.map((interview) => {
      ...
      <div className="flex flex-col h-[80vh] min-h-5/6 bg-white rounded-xl lg:w-1/4 overflow-y-scroll">
        <span className="bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br  py-4 text-white text-center rounded-xl">
          Rejected
        </span>
        <div className="bg-white p-4 m-2">
          {rejected?.map((interview) => {
            return (
              <div class="relative py-8 px-4 mt-1 sm:px-8 border-2 border-gray-200 dark:border-gray-700 max-w-sm mx-auto bg-white rounded-xl shadow-lg space-y-2 sm:py-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-6">
                <svg
                  class="absolute top-2 right-2 cursor-pointer w-6 h-6 sm:top-4 sm:right-4 text-gray-800 dark:text-white"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
      ...
      {jobOfferModal && <div className="modal-backdrop"></div>}
    </div>
  );
};
