...
var ChatHeader = function ChatHeader(props) {
  ...
  }, otherMember.is_online ? 'Online' : 'Offline')), React__default.createElement("div", {
...
var ChatForm = function ChatForm(props) {
  ...
  }, React__default.createElement(icons.PlusOutlined, null)), React__default.createElement("style", null, ".ce-create-chat-button:hover { background-color: #40a9ff; }"));
};
...
var ChatListHeader = function ChatListHeader(props) {
  ...
  }, "Chats"), React__default.createElement("button", {
